...
# each letter by the same amount. For example, "cheer" rotated by 7 is "jolly" 
# and "melon" rotated by -10 is "cubed". In the movie 2001: A Space Odyssey, the
# ship computer is called HAL, which is IBM rotated by -1.
#
# Question 1
# 1. Write a function called rotate_word that takes a string and an integer as 
# parameters, and returns a new string that contains the letters from the 
